...
class AbstractListagem:
    def __init__(self, nome_tela: str,
                 texto_botoes: list, lista_pessoas: list):
        self.__nome_tela = nome_tela
        self.__texto_botoes = texto_botoes
        self.__lista_pessoas = lista_pessoas
        self.__janela = None

    def configura(self, texto_botoes: list, lista_pessoas: list):
        sg.ChangeLookAndFeel("Reddit")

        layout = [[sg.Listbox(values=lista_pessoas,
    ...
    def mostra_opcoes(self):
        self.configura(self.__texto_botoes, self.__lista_pessoas)
